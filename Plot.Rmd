...
**Four questions I can answer using this dataset:**
...
2. How many restaurants in NYC were inspected each day in 2017?
...
3. Among the inspected restaurant in each borough, what proportion of them received grade A for their inspections?
```{r Q3 pie chart, warning = FALSE}
grade_A = tibble(
  nyc_inspection %>%
  filter(grade == "A") %>% 
  group_by(borough) %>% 
...
4. What are the top 10 most common violation codes among the inspected restaurants in 2017?
```{r Q4 most common violation code}
violation = 
  nyc_inspection %>%
